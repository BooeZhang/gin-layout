...
type Manager interface {
	SyncSysUserRoles(ctx context.Context, userAccount string, roleCodes []string) error
	SyncSysUserRolesByIDs(ctx context.Context, userAccount string, roleIDs []int64) error
